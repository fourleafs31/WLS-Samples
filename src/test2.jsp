...
private static String BODY="<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Header xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"></soap:Header><soapenv:Body><test:hello xmlns:test=\"http://test\"/></soapenv:Body></soapenv:Envelope>";
